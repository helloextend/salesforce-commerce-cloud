...
function addExtendWarrantyToCart(currentBasket, product, parentLineItem, form) {
    ...
    Transaction.wrap(function () {
        ...
        warrantyLi.setProductName('Extend Product Protection: ' + parseInt(form.extendTerm / 12) + ' years for ');
...
server.append('AddProduct', function (req, res, next) {
    ...
    var form = req.form;
    // var extendPlanId = form.extendPlanId;
    var isProductSkip = form.pskip;
    var viewData = res.getViewData(); // pliUUID

    if (form.extendPlanId && form.extendPrice && form.extendTerm && isProductSkip) {
