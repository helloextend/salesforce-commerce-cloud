...
function getProductDetailUrl(pdict) {
    ...
    var urlParams = {
        cgid: pdict.CurrentHttpParameterMap.cgid.stringValue,
        ...
        Quantity: pdict.CurrentHttpParameterMap.Quantity.stringValue || pdict.quantity,
